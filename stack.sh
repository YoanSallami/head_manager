...
rosservice call /toaster_simu/set_entity_pose "{id: 'RED_CUBE', ownerId: '', type: 'object', x: 7.34, y: 6.175, z: 0.75, roll: 0.0, pitch: 0.0, yaw: 0.0}"
rosservice call /toaster_simu/add_entity "{id: 'GREEN_CUBE', name: 'GREEN_CUBE', type: 'object', ownerId: ''}"
rosservice call /toaster_simu/set_entity_pose "{id: 'GREEN_CUBE', ownerId: '', type: 'object', x: 7.24, y: 6.075, z: 0.75, roll: 0.0, pitch: 0.0, yaw: 0.0}"

rosservice call /toaster_simu/add_entity "{id: 'BLUE_CUBE', name: 'BLUE_CUBE', type: 'object', ownerId: ''}"
rosservice call /toaster_simu/set_entity_pose "{id: 'BLUE_CUBE', ownerId: '', type: 'object', x: 7.64, y: 6.975, z: 0.75, roll: 0.0, pitch: 0.0, yaw: 0.0}"
rosservice call /toaster_simu/add_entity "{id: 'BLACK_CUBE', name: 'BLACK_CUBE', type: 'object', ownerId: ''}"
rosservice call /toaster_simu/set_entity_pose "{id: 'BLACK_CUBE', ownerId: '', type: 'object', x: 7.54, y: 7.075, z: 0.75, roll: 0.0, pitch: 0.0, yaw: 0.0}"
